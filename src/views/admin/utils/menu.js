...
export const ADMIN_MENU_ITEMS = [
  ...
  { key: 'recharge', path: '/admin/recharge', label: '充值管理', desc: '付款码与联系二维码', group: '用户管理', permission: 'admin:recharge_manage', icon: QrCode },
  { key: 'rechargeRequests', path: '/admin/recharge-requests', label: '充值记录', desc: '凭证审核与入账', group: '用户管理', permission: 'admin:view_recharge_requests', icon: ClipboardList },
