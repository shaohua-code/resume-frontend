...
const columns = [
  ...
  { title: '来源', dataIndex: 'visit_source', key: 'visit_source', width: 140 },
    ...
    <a-card :bordered="false" class="card-base">
      <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p class="text-sm text-muted">仅超级管理员可见，保留近 30 天数据</p>
        </div>
        <button class="btn-primary" @click="loadVisits">刷新</button>
      </div>
    </a-card>
